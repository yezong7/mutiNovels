---
name: "new-chapter"
description: "Creates a new chapter file and updates project state. Invoke when user inputs 【新建章节】 or asks to start a new chapter."
---
...
使用 SearchReplace 工具将新行插入表格。

### 5. 更新 state.md

使用 Read 工具读取 `{项目}/state.md`，然后使用 SearchReplace 工具更新以下字段：
